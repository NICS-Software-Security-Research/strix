...
<ParamField path="STRIX_OPENAI_API_MODE" type="string">
  Select `responses` to use the Responses API with a custom OpenAI-compatible base URL. When unset, custom base URLs continue to use `chat_completions`.
</ParamField>
